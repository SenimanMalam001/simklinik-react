  ...
  render() {
    ...
    return (
        ...
        />
      {
        ...
        <Table
          data={penjualans}
          thead={['No Trans','Pasien','Penjamin','Total Akhir','Keterangan','Petugas','Penginput','Waktu','Aksi']}
          tbody={['no_trans','pasien','penjamin','total_akhir','keterangan','petugas','penginput','waktu']}
